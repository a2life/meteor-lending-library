 ...
 */
    ...
    function updateLendee(list_id,item_name,lendee_name){
        // console.log('update lendee called list_id ;'+list_id +' item name '+item_name+' lendee name '+lendee_name);
        ...
        if (l&&l.items)
        {
            ...
            //    console.log('mongo update executed');
        }
    };
    ...
    Template.list.events({
        ...
        'click .lendee' : function(e,t){
            ...
            Tracker.flush();
            focusText(t.find("#edit_lendee"),this.LenTo);
        },
